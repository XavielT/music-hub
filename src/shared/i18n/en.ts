...
export const EN = {
  ...
  'auth.invited': "You have been invited. Pick a password and you're in — no one needs to add you first.",
  ...
  'settings.diagnosticsHint': 'Records how the app starts, so a launch problem can be read back.',
  'settings.diagnosticsOn': 'Turn on',
  'settings.diagnosticsOff': 'Turn off',
  'settings.diagnosticsReport': 'Start-up report',
  'settings.diagnosticsReportHint': 'Device, version and what happened during the last two launches.',
  'settings.diagnosticsCopied': 'Report copied.',
  'settings.copy': 'Copy',
  ...
  'admin.inviteLinkNote':
    'A link that carries its own permission. Send it and they can register straight away — you never need their address first. Single use, valid for 7 days.',
  'admin.inviteLinkWhoFor': 'Who is it for?',
  'admin.inviteLinkCreate': 'Create link',
  'admin.inviteLinkOnce': 'Copy this now — it is shown once and cannot be read back.',
  'admin.inviteLinkCopy': 'Copy link',
  'admin.inviteLinkCopiedShort': 'Copied',
  'admin.inviteLinkCopied': 'Invite link copied.',
  'admin.inviteLinkCopyFailed': 'Could not copy — select the link and copy it by hand.',
  'admin.inviteLinkLoading': 'Loading links…',
  'admin.inviteLinkNoNote': 'Invite link',
  'admin.inviteLinkRevoke': 'Revoke',
  'admin.inviteLinkConfirmRevoke': 'Sure?',
  'admin.inviteLinkRevoked': 'Invite link revoked.',
  'admin.inviteLinkNotAdmin': 'Only an admin can manage invite links.',
  'admin.inviteLinkFailed': 'Could not create the invite link.',
  'admin.inviteLinkStatus.open': 'Open',
  'admin.inviteLinkStatus.used': 'Used',
  'admin.inviteLinkStatus.revoked': 'Revoked',
  'admin.inviteLinkStatus.expired': 'Expired',
  'admin.invitesNote':
