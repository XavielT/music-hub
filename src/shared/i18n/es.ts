...
export const ES: Record<TranslationKey, string> = {
  ...
  'song.badge.onDevice': 'En este dispositivo',
  'song.badge.download': 'Descargar para escuchar sin conexión',
  'song.badge.downloading': 'Descargando…',
  'song.badge.cloud': 'En la biblioteca compartida',
  'song.badge.localOnly': 'Solo en este dispositivo',
  'song.badge.upload': 'Subir a la biblioteca compartida',
  ...
  'add.status.pending': 'Esperando a que un dispositivo la descargue',
  'add.status.working': 'Descargándose ahora…',
  'add.status.done': 'Añadida a la biblioteca',
  'add.status.failed': 'No se pudo descargar — {error}',
